CREATE TABLE `criterionAssessments` (
	...
	`assessment` enum('directly_evidenced','indirectly_relevantly_evidenced','inferred','not_found','contradicted','demonstrated','partial','unsupported') NOT NULL,
...
CREATE TABLE `evidenceDocuments` (
	...
	`documentType` enum('evidence','target','current_role') NOT NULL,
