...
import { AnalysisFailureAlert } from "./AnalysisFailureAlert";

describe("AnalysisFailureAlert", () => {
  it("renders a persistent actionable message for an invalid Objective B generation", () => {
    const html = renderToStaticMarkup(<AnalysisFailureAlert message="Objective B could not generate a validated, source-linked appraisal report (malformed json). No empty report has been saved." />);
