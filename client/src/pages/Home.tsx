...
export default function Home() {
  ...
  return (
    <div className="flex min-h-screen flex-col bg-background text-foreground">
      ...
      <div className="mt-auto border-t border-primary/20 bg-primary px-4 py-3 text-center text-[11px] leading-5 text-primary-foreground"><p>This tool provides decision support from supplied evidence only. It does not determine employment eligibility, banding/grading decisions, legal rights, job-evaluation outcomes, or professional competence for any profession.</p><p className="mt-1 text-primary-foreground/70"><Link href="/privacy" className="underline-offset-2 hover:underline">Privacy</Link><span className="mx-2">·</span><Link href="/terms" className="underline-offset-2 hover:underline">Terms</Link><span className="mx-2">·</span><a href="mailto:privacy@provemycv.com" className="underline-offset-2 hover:underline">Contact</a></p></div>
