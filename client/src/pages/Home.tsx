...
const objectives: Record<Objective, { title: string; label: string; description: string; icon: typeof Target }> = {
  ...
  C: { title: "Wondering if my role matches my pay", label: "Objective C", description: "Compare what you actually do day-to-day against your official role — for your own reference only, never a banding decision.", icon: Scale },
};
